...
!function(){function e(e,n,r,t,c,i,o,u,f,m){return{connection:function(){return new r},search:function(e,n,r,c,i){return t(e,n,r,c,i)},member:function(e){return new c(e)},repo:function(e){return new i(e)},workingDir:function(e){return new o(e)},commit:function(e,n){return new u(e,n)},tree:function(e){return new f(e)},lump:function(e){return new m(e)}}}angular.module("dySdk").factory("Datary",e),e.$inject=["$q","$http","ConnectionService","searchFactory","MemberService","RepoService","WorkingDirService","CommitService","TreeService","LumpService"]}();
