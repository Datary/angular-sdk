...
!function(){angular.module("dySdk",["ngFileUpload"]).constant("baseApiUrl","https://api.datary.io/")}();
...
!function(){function n(n,t,r){function u(e){var u=r+e;return t.get(u).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function c(e){var u=r+e+"/repos";return t.get(u).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function i(e){var u=r+e+"/activity";return t.get(u).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function o(e){var u=r+e+"/sessions";return t.get(u).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function f(e,u){var c=r+u+"/repos";return t.post(c,e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function a(e,u){var c=r+u;return t.put(c,e).then(function(n){return n})["catch"](function(t){return n.reject(t)})}function s(e,u){var c=r+u+"/username";return t.put(c,u).then(function(n){return n})["catch"](function(t){return n.reject(t)})}function h(e,u,c){var i=r+c+"/password",o={oldPassword:e,newPassword:u};return t.put(i,o).then(function(n){return n})["catch"](function(t){return n.reject(t)})}function v(e){var u=r+e;return t["delete"](u).then(function(n){return e})["catch"](function(t){return n.reject(t)})}function d(u,c){return o.then(function(n){var t=n.map(function(n){return n.jti}).indexOf(u);n.splice(t,1);var r=n.map(function(n,t,r){return n.encoding});return r},function(t){return n.reject(e)}).then(function(n){var e=n;return t.put(r+c+"/sessions",e).then(function(n){return n},function(n){return n})})}return function(n){this.guid=n,this.describe=function(){return u(n)},this.retrieveRepos=function(){return c(n)},this.retrieveActivity=function(){return i(n)},this.retrieveSessions=function(){return o(n)},this.createRepo=function(t){return f(t,n)},this.updateProfile=function(t){return a(t,n)},this.changeUsername=function(t){return s(t,n)},this.changePassword=function(t,r){return h(t,r,n)},this.remove=function(){return v(n)},this.removeSession=function(t){return d(t,n)}}}angular.module("dySdk").service("MemberService",n),n.$inject=["$q","$http","baseApiUrl"]}();
