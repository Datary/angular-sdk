...
!function(){function n(n,t,r){function c(e){return t.post(r+"connection/signUp",e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function o(e){return t.post(r+"connection/activate",e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function u(c){return t.post(r+"connection/signIn?provider=datary",c).then(function(t){var r=null;return t.headers("X-Set-Token")?r=t.headers("X-Set-Token"):t.data&&t.data.authToken?r=t.data.authToken:(console.log("Could not parse token from HTTP reponse."),n.reject(e))})["catch"](function(t){return n.reject(t)})}function i(){return t.get(r+"connection/signOut").then(function(n){return n.status})["catch"](function(t){return n.reject(t)})}function a(e){var c=r+"connection/signRequest";return c+="&operation="+e.operation,c+="&basename="+e.basename,c+="&contentType="+e.contentType,t.get(c).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}return function(){this.signUp=function(n){return c(n)},this.activate=function(n){return o(n)},this.signIn=function(n){return u(n)},this.signOut=function(){return i()},this.signRequest=function(n){return a(n)}}}angular.module("dySdk").service("ConnectionService",n),n.$inject=["$q","$http","baseApiUrl"]}();
