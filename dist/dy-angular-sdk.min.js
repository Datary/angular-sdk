...
!function(){angular.module("dySdk",["ngFileUpload"]).constant("baseApiUrl","https://datary-apiserver-rtm-us1-a.azurewebsites.net/")}();
...
!function(){function t(t,n,r){return function(e,i,o,u,a){var c=e?e.toString():"members",f=i?i.toString():"username",g=o?o.toString():".*",S=u?u.toString():"25",h=a?a.toString():"0";return $URI=r+"search/"+c+"?path="+f+"&hint="+g+"&limit="+S+"&offset="+h,n.get($URI).then(function(t){return t.data},function(n){return t.reject(n)})}}angular.module("dySdk").factory("searchService",t),t.$inject=["$q","$http","baseApiUrl"]}();
...
!function(){function t(t,n,e){function r(r,c){var i=e;return i=c?i.concat(c+"/"):i,i=c?i.concat(r+"?branch=true"):i.concat(r+"/branch"),n.get(i).then(function(t){return t.data},function(n){return t.reject(n)})}function c(r,c){var i=e;return i=c?i.concat(c+"/"):i,i=c?i.concat(r+"?filetree=true"):i.concat(r+"/filetree"),n.get(i).then(function(t){return t.data},function(n){return t.reject(n)})}return function(t,n){this._id=t,this.namespace=n,this.retrieveBranch=function(){return r(t,n)},this.retrieveFiletree=function(){return c(t,n)}}}angular.module("dySdk").service("commitService",t),t.$inject=["$q","$http","baseApiUrl"]}();
!function(){function n(n,t,e){function r(r){return t.get(e+r).then(function(n){return n.data},function(t){return n.reject(t)})}return function(n){this._id=n,this.describe=function(){return r(n)}}}angular.module("dySdk").service("treeService",n),n.$inject=["$q","$http","baseApiUrl"]}();
!function(){function e(e,r,t){function n(n){return r.get(t+n+"/original").then(function(e){return e.data},function(r){return e.reject(r)})}return function(e){this._id=e,this.retrievePreview=function(){return retrievePreviewFromLump(e)},this.retrieveExtract=function(){return retrieveExtractFromLump(e)},this.retrieveOriginal=function(){return n(e)}}}angular.module("dySdk").service("lumpService",e),e.$inject=["$q","$http","baseApiUrl"]}();