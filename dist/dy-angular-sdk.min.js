...
!function(){function e(e,a,o){return{request:function(e){return e.headers=e.headers||{},o.localStorage.authToken&&"undefined"!==o.localStorage.authToken&&"null"!==o.localStorage.authToken&&(e.headers.Authorization="Bearer "+o.localStorage.authToken),e},response:function(e){switch(e.status){case 300:case 301:console.log("Successful API call. Redirecting.");break;case 200:case 201:case 204:}return e},responseError:function(a){switch(a.status){case 401:case 403:console.log("Unsuccessful API call. Authentication/Authorization failed.");break;case 404:console.log("Unsuccessful API call. Document not found.");break;case 500:console.log("Unsuccessful API call. Internal server error.");break;default:console.log("Unsuccessful API call.")}return a.data=a.data||{},e.reject(a.data)}}}angular.module("dySdk").factory("dyTokenInterceptor",e),e.$inject=["$q","$location","$window"]}();
...
!function(){function t(t,n,r){return function(e,i,o,a,c){var u=e?e.toString():"members",f=i?i.toString():"username",g=o?o.toString():".*",h=a?a.toString():"25",s=c?c.toString():"0",S=r+"search";return S+="/"+u,S+="?path="+f,S+="&hint="+g,S+="&limit="+h,S+="&offset="+s,n.get(S).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}}angular.module("dySdk").factory("searchFactory",t),t.$inject=["$q","$http","baseApiUrl"]}();
!function(){function n(n,t,r){function c(e){return t.post(r+"connection/signUp",e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function o(e){return t.post(r+"connection/activate",e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function u(c){return t.post(r+"connection/signIn",c).then(function(t){var r=null;return t.headers("X-Set-Token")?r=t.headers("X-Set-Token"):t.data&&t.data.authToken?r=t.data.authToken:(console.log("Could not parse token from HTTP reponse."),n.reject(e))})["catch"](function(t){return n.reject(t)})}function i(e){return t.post(r+"connection/recover",{email:e}).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function a(e){return t.post(r+"connection/reset",e).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}function s(){return t.get(r+"connection/signOut").then(function(n){return n.status})["catch"](function(t){return n.reject(t)})}function f(e){var c=r+"connection/signRequest";return c+="&operation="+e.operation,c+="&basename="+e.basename,c+="&contentType="+e.contentType,t.get(c).then(function(n){return n.data})["catch"](function(t){return n.reject(t)})}return function(){this.signUp=function(n){return c(n)},this.activate=function(n){return o(n)},this.signIn=function(n){return u(n)},this.recover=function(n){return i(n)},this.reset=function(n){return a(n)},this.signOut=function(){return s()},this.signRequest=function(n){return f(n)}}}angular.module("dySdk").service("ConnectionService",n),n.$inject=["$q","$http","baseApiUrl"]}();
!function(){function t(t,n,r){function u(e){var u=r+e;return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function c(e){var u=r+e+"/repos";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function i(e){var u=r+e+"/disclosedRepos";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function o(e){var u=r+e+"/privateRepos";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function f(e){var u=r+e+"/activity";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function a(e){var u=r+e+"/publicActivity";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function s(e){var u=r+e+"/sessions";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function h(e,u){var c=r+u+"/repos";return n.post(c,e).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function v(e,u){var c=r+u;return n.put(c,e).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function d(e,u){var c=r+u+"/username";return n.put(c,u).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function p(e,u,c){var i=r+c+"/password",o={oldPassword:e,newPassword:u};return n.put(i,o).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function j(e){var u=r+e;return n["delete"](u).then(function(t){return e})["catch"](function(n){return t.reject(n)})}function g(u,c){return s.then(function(t){var n=t.map(function(t){return t.jti}).indexOf(u);t.splice(n,1);var r=t.map(function(t,n,r){return t.encoding});return r},function(n){return t.reject(e)}).then(function(t){var e=t;return n.put(r+c+"/sessions",e).then(function(t){return t},function(t){return t})})}return function(t){this.guid=t,this.describe=function(){return u(t)},this.retrieveRepos=function(){return c(t)},this.retrieveDisclosedRepos=function(){return i(t)},this.retrievePrivateRepos=function(){return o(t)},this.retrieveActivity=function(){return f(t)},this.retrievePublicActivity=function(){return a(t)},this.retrieveSessions=function(){return s(t)},this.createRepo=function(n){return h(n,t)},this.updateProfile=function(n){return v(n,t)},this.changeUsername=function(n){return d(n,t)},this.changePassword=function(n,r){return p(n,r,t)},this.remove=function(){return j(t)},this.removeSession=function(n){return g(n,t)}}}angular.module("dySdk").service("MemberService",t),t.$inject=["$q","$http","baseApiUrl"]}();
!function(){function t(t,n,e,r,u){function c(r){return n.get(e+r).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function i(n){return c(n).then(function(t){return new r(t.workingDir).describe()}).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function o(n){return c(n).then(function(t){return new u(t.apex.commit,n).retrieveFiletree()}).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function f(r){var u=e+r+"/readme";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function a(r){var u=e+r+"/license";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function h(r){var u=e+r+"/heads";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function s(r){var u=e+r+"/tags";return n.get(u).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function v(r){var u=e+r+"/refs";return n.get(u).then(function(t){return t.data},function(n){return t.reject(n)})}function d(r,u,c){var i=e+r;if((u||c)&&(i+="/?"),u&&(i+="namespace="+u+"&"),c)for(var o in c)i+=o+"="+c[o]+"&";return n.get(i).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function j(r,u){var c=e+u+"/index";return n.post(c,r).then(function(t){return u})["catch"](function(n){return t.reject(n)})}function g(r,u){var c=e+u+"/readme";return n.put(c,r).then(function(t){return t})["catch"](function(n){return t.reject(n)})}function m(r,u){var c=e+u;return n.put(c,r).then(function(t){return u})["catch"](function(n){return t.reject(n)})}function p(r){var u=e+r;return n["delete"](u).then(function(t){return r})["catch"](function(n){return t.reject(n)})}return function(t){this.guid=t,this.describe=function(){return c(t)},this.retrieveWorkingDir=function(){return i(t)},this.retrieveApexFiletree=function(){return o(t)},this.retrieveReadme=function(){return f(t)},this.retrieveLicense=function(){return a(t)},this.retrieveHeads=function(){return h(t)},this.retrieveTags=function(){return s(t)},this.retrieveRefs=function(){return v(t)},this.retrieveObject=function(n,e){return d(n,t,e)},this.commitIndex=function(n){return j(n,t)},this.updateReadme=function(n){return g(n,t)},this.updateDetails=function(n){return m(n,t)},this.remove=function(){return p(t)}}}angular.module("dySdk").service("RepoService",t),t.$inject=["$q","$http","baseApiUrl","WorkingDirService","CommitService"]}();
!function(){function t(t,n,e,r,c){function o(r){return n.get(e+r).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function i(r){var c=e+r+"/changes";return n.get(c).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function u(r){var c=e+r+"/filetree";return n.get(c).then(function(t){return t.data})["catch"](function(n){return t.reject(n)})}function a(r,o){var i,u=e+o+"/changes",a={};if("add"!==r.action)return n.post(u,r).then(function(t){return t})["catch"](function(n){return t.reject(n)});if(4e4===r.filemode)return n.post(u,r).then(function(t){return t})["catch"](function(n){return t.reject(n)});if(!("object"!=typeof r.content||r.content instanceof File))return n.post(u,r).then(function(t){return t})["catch"](function(t){return $reject(t)});if("string"==typeof r.content){try{a=JSON.parse(r.content)}catch(f){return t.reject(new Error("Imported file does not conforms to JSON format"))}return r.content=a,n.post(u,r).then(function(t){return t})["catch"](function(t){return $reject(t)})}if("object"==typeof r.content&&r.content instanceof File){if(r.content.size<10485760){var s=new FileReader,h=t.defer();return s.onload=function(){i=s.result;try{a=JSON.parse(i)}catch(t){return h.reject(new Error("Imported file does not conforms to JSON format"))}r.content=a,n.post(u,r).then(function(t){h.resolve(t.status)})["catch"](function(t){h.reject(t)})},s.readAsText(r.content,"UTF-8"),h.promise}return c.upload({method:"POST",url:e+o+"/changes",fields:{action:r.action,filetype:r.filetype,dirname:r.dirname,basename:r.basename,content:null,pattern:r.pattern},file:r.content})}}function f(t,r){return i.then(function(t){})["catch"](function(t){}).then(function(t){var c=t;return n.put(e+r+"/changes",c).then(function(t){return t})["catch"](function(t){return t})})}return function(t){this.guid=t,this.describe=function(){return o(t)},this.listChanges=function(){return i(t)},this.retrieveFiletree=function(){return u(t)},this.stageChange=function(n){return a(n,t)},this.unstageChange=function(n){return f(n,t)}}}angular.module("dySdk").service("WorkingDirService",t),t.$inject=["$q","$http","baseApiUrl","ConnectionService","Upload"]}();
!function(){function t(t,e,n){function r(r,c){var i=n;return i+=r,c&&(i+="?namespace="+c),e.get(i).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function c(r,c){var i=n;return i+=r+"/branch",c&&(i+="?namespace="+c),e.get(i).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function i(r,c){var i=n;return i+=r+"/filetree",c&&(i+="?namespace="+c),e.get(i).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}return function(t,e){this.guid=t,this.namespace=e,this.describeCommit=function(){return r(t,e)},this.retrieveBranch=function(){return c(t,e)},this.retrieveFiletree=function(){return i(t,e)}}}angular.module("dySdk").service("CommitService",t),t.$inject=["$q","$http","baseApiUrl"]}();
!function(){function e(e,n,t){function r(r,c){var i=t+r;return c&&(i+="?namespace="+c),n.get(i).then(function(e){return e.data})["catch"](function(n){return e.reject(n)})}return function(e,n){this.guid=e,this.namespace=n,this.describe=function(){return r(e,n)}}}angular.module("dySdk").service("TreeService",e),e.$inject=["$q","$http","baseApiUrl"]}();
!function(){function t(t,e,n){function r(r,c){var u=n+r;return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function c(r,c){var u=n+r+"/original";return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function u(r,c){var u=n+r+"/preview";return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function a(r,c){var u=n+r+"/sample";return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function i(r,c){var u=n+r+"/metadata";return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}function o(r,c){var u=n+r+"/blob";return c&&(u+="?namespace="+c),e.get(u).then(function(t){return t.data})["catch"](function(e){return t.reject(e)})}return function(t,e){this.guid=t,this.namespace=e,this.describe=function(){return r(t,e)},this.retrieveOriginal=function(){return c(t,e)},this.retrievePreview=function(){return u(t,e)},this.retrieveSample=function(){return a(t,e)},this.retrieveMetadata=function(){return i(t,e)},this.retrieveBlob=function(){return o(t,e)}}}angular.module("dySdk").service("DatasetService",t),t.$inject=["$q","$http","baseApiUrl"]}();